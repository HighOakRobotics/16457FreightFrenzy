...
public class LegacyGoToArmWaypointTask extends Task {
    ...
    public LegacyGoToArmWaypointTask(Arm arm, ArmWaypointGraph.ArmWaypointName target) {
        this.arm = arm;
        this.target = target;
